...
namespace PearUp.Repository.Migrations
{
    ...
    partial class PearUpContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("PearUp.BusinessEntity.User", b =>
                {
                    ...
                    b.OwnsOne("PearUp.BusinessEntity.Location", "Location", b1 =>
                        {
                            b1.Property<int>("UserId");
                            ...
                            b1.HasOne("PearUp.BusinessEntity.User")
                                .WithOne("Location")
                                .HasForeignKey("PearUp.BusinessEntity.Location", "UserId")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
